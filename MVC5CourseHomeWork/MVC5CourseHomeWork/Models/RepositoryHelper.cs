namespace MVC5CourseHomeWork.Models
{
	public static class RepositoryHelper
	{
		...
		public static 客戶聯絡人及帳戶數量Repository Get客戶聯絡人及帳戶數量Repository()
		{
			var repository = new 客戶聯絡人及帳戶數量Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static 客戶聯絡人及帳戶數量Repository Get客戶聯絡人及帳戶數量Repository(IUnitOfWork unitOfWork)
		{
			var repository = new 客戶聯絡人及帳戶數量Repository();
			repository.UnitOfWork = unitOfWork;
			return repository;
